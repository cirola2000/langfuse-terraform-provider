...
install-all: build-all
	# Darwin ARM64
	mkdir -p ~/.terraform.d/plugins/registry.terraform.io/cirobaronneto/langfuse/1.0.0/darwin_arm64
	cp terraform-provider-langfuse-darwin-arm64 ~/.terraform.d/plugins/registry.terraform.io/cirobaronneto/langfuse/1.0.0/darwin_arm64/terraform-provider-langfuse
	# Darwin AMD64
	mkdir -p ~/.terraform.d/plugins/registry.terraform.io/cirobaronneto/langfuse/1.0.0/darwin_amd64
	cp terraform-provider-langfuse-darwin-amd64 ~/.terraform.d/plugins/registry.terraform.io/cirobaronneto/langfuse/1.0.0/darwin_amd64/terraform-provider-langfuse
	# Linux AMD64
	...
	# Linux ARM64
	mkdir -p ~/.terraform.d/plugins/registry.terraform.io/cirobaronneto/langfuse/1.0.0/linux_arm64
	cp terraform-provider-langfuse-linux-arm64 ~/.terraform.d/plugins/registry.terraform.io/cirobaronneto/langfuse/1.0.0/linux_arm64/terraform-provider-langfuse
	# Windows AMD64
	mkdir -p ~/.terraform.d/plugins/registry.terraform.io/cirobaronneto/langfuse/1.0.0/windows_amd64
	cp terraform-provider-langfuse-windows-amd64.exe ~/.terraform.d/plugins/registry.terraform.io/cirobaronneto/langfuse/1.0.0/windows_amd64/terraform-provider-langfuse.exe
